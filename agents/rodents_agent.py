...
def _scf(
    ...
    slug: str,
    per_page: int = 20,
    pest_only: bool = False,
) -> dict:
    """Genera una entrada SeeClickFix para RODENT_SOURCES.
    Evita copiar el mismo bloque de 18 líneas por cada ciudad.
    """
    types = ["Rats/Rodents", "Pest Control"]
    if not pest_only:
        types.append("Animal Control")
    return {
        "city":   city,
        "engine": "seeclickfix",
...
RODENT_SOURCES = [
    ...
    # ── Oakland — SeeClickFix (per_page 30 por mayor densidad) ─────────
    _scf("Oakland",             "oakland",             per_page=30),
    _scf("Fremont",             "fremont",             pest_only=True),
    _scf("Pleasant Hill",       "pleasant-hill"),
    _scf("Walnut Creek",        "walnut-creek"),
    _scf("Martinez",            "martinez"),
    _scf("Clayton",             "clayton"),
    _scf("Pittsburg",           "pittsburg"),
    _scf("Lafayette",           "lafayette"),
    _scf("Benicia",             "benicia"),
    _scf("Orinda",              "orinda"),
    _scf("Antioch",             "antioch"),
    _scf("Moraga",              "moraga"),
    _scf("Alamo",               "alamo"),
    _scf("Danville",            "danville"),
    _scf("Hercules",            "hercules"),
    _scf("Pinole",              "pinole"),
    _scf("Oakley",              "oakley"),
    _scf("San Ramon",           "san-ramon"),
    _scf("Vallejo",             "vallejo"),
    _scf("Richmond",            "richmond"),
    _scf("Brentwood",           "brentwood"),
    _scf("El Cerrito",          "el-cerrito"),
    _scf("Albany",              "albany"),
    _scf("Emeryville",          "emeryville"),
    _scf("Dublin",              "dublin"),
    _scf("Alameda",             "alameda"),
    _scf("Fairfield",           "fairfield"),
    _scf("San Leandro",         "san-leandro"),
    _scf("Pleasanton",          "pleasanton"),
    _scf("Hayward",             "hayward"),
    _scf("Livermore",           "livermore"),
    _scf("Napa",                "napa"),
    _scf("Vacaville",           "vacaville"),
    _scf("Daly City",           "daly-city"),
    _scf("South San Francisco", "south-san-francisco"),
    _scf("Union City",          "union-city"),
    _scf("Rio Vista",           "rio-vista"),
    _scf("San Bruno",           "san-bruno"),
    _scf("Newark",              "newark"),
    _scf("Millbrae",            "millbrae"),
    _scf("Burlingame",          "burlingame"),
    _scf("San Mateo",           "san-mateo"),
    _scf("Sonoma",              "sonoma"),
    _scf("Tracy",               "tracy"),
    _scf("Petaluma",            "petaluma"),
    _scf("Stockton",            "stockton"),
    _scf("Novato",              "novato"),
    _scf("San Rafael",          "san-rafael"),
    _scf("Castro Valley",       "castro-valley"),
    _scf("San Lorenzo",         "san-lorenzo"),
    _scf("Suisun City",         "suisun-city"),
    _scf("Concord",             "concord"),
]
