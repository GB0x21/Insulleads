...
from utils.inspection_filters import (
    is_enforcement_inspection as _is_enforcement_inspection,
    is_future_inspection as _is_future_inspection,
...
# `_parse_date` is re-exported for backwards-compat — callers (and
# tests) import from `agents.permits_agent`. The implementation lives
# in `utils.inspection_filters`.
_parse_date = _parse_date_shared
